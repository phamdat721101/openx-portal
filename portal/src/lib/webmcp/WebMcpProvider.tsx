...
export function WebMcpProvider({ children }: { children: React.ReactNode }) {
  ...
  React.useEffect(() => {
    ...
    const tools: Tool[] = [
      ...
      { name: 'openx_get_wallet_summary', description: 'Read the public Status Network wallet balance summary for an OpenX agent.', inputSchema: withAgentId({}), execute: async (input) => webMcpWallet(String(input.agent_id)) },
