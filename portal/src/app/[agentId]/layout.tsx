...
import { ArrowLeft, Wrench, Sliders, Moon, Bot, ShieldCheck, ListChecks, ChartNoAxesCombined } from 'lucide-react';
...
export default function AgentLayout({ params, children }: AgentLayoutProps) {
  ...
  const tabs = [
    ...
    { slug: 'statements', label: 'Statement Tracking', icon: ChartNoAxesCombined },
